...
def build_alibi_tensor(bool_attention_mask: Tensor, num_heads: int, dtype: paddle.dtype) -> Tensor:
...
class LlamaModel(LlamaPretrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.layers = nn.LayerList([LlamaDecoderLayer(config) for i in range(config.num_hidden_layers)])
